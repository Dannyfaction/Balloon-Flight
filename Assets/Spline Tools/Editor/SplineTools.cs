...
namespace SplineTool
{
    ...
    public class SplineTools : EditorWindow
    {
        ...
        void OnEnable()
        {
            Instance = this;
            // loading imgs
            save = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Spline Tools/imgs/save.png", typeof(Texture));
            delete = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Spline Tools/imgs/delete.png", typeof(Texture));
            reload = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Spline Tools/imgs/reload.png", typeof(Texture));
            drawLine = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Spline Tools/imgs/drawLine.png", typeof(Texture));
            saveAs = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Spline Tools/imgs/save as.png", typeof(Texture));
        }
