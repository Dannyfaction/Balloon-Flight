...
namespace SplineTool
{
    ...
    public class SplinePrefs
    {
        ...
        public static HotKey sharpen;
        public const string SHARPEN_KEY = "sharpen";
        #endregion
        ...
        public static void InitializeHotKeys()
        {
            ...
            sharpen = GetHotkey(SHARPEN_KEY);
            if(sharpen.keyCode == KeyCode.None)
            {
                sharpen = new HotKey(KeyCode.P, true, false, false);
            }
        }
