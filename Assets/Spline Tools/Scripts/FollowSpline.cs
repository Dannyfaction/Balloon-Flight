...
namespace SplineTool
{
    ...
    public class FollowSpline : MonoBehaviour
    {
        ...
        /// it control the smoothness of the movement
        /// </summary>
        [Range(0.01f, 100)]
        ...
        int _currPoint;
        public int CurrPoint { get { return _currPoint; } set { _currPoint = value; } }
        ...
        void Start()
        {
            ...
            {
                Debug.LogWarning("no spline found to follow");
            }
            else
            {
        ...
        public void ChooseSubwayPlayer(ref int i, Vector3[] nextPos)
        {
            ...
            if (arrows == null)
            {
                ...
                */
                ...
                //BoatMovementStream = GetComponent<BoatMovementStream>();
                //ChoosedSubway(BoatMovementStream.LeftRight);
                ChoosedSubway(1);
            }
        ...
        {
            if (_currPoint < spline.Length - 1 && !reverse) _currPoint++;
            else if (_currPoint > 0 && reverse) _currPoint--;
